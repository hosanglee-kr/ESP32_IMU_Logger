...
/* ============================================================================
 * File: T20_Mfcc_Def_056.h
 * Summary:
 *   T20 MFCC / Recorder / Viewer / Web 모듈의 공개 상수/열거형/구조체 정의
 *
 * [이번 버전 목적]
 * - 컴파일 복구용 기준 세트를 다시 맞춘 "정합성 우선 베이스라인"
 * - 이전 확장판에서 섞여 있던 구조체/매크로/시그니처를 단일 리비전으로 재정리
 *
 * [중요]
 * - 본 파일은 "중복 정의 금지"를 최우선으로 정리함
 * - 향후 단계 구현 예정 사항은 TODO 주석으로 유지
 * ========================================================================== */

/* ============================================================================
 * [기본 문자열 / 버전]
 * ========================================================================== */
#define G_T20_VERSION_STR                         "T20_Mfcc_056"
