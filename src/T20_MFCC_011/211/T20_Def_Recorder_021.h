...
/* --- [Recorder Configuration Constants] --- */
...
/* --- [Recorder State Transition Constants (Full)] --- */
...
/* --- [Enums & Structs] --- */
enum EM_T20_OutputMode_t { EN_T20_OUTPUT_VECTOR = 0, EN_T20_OUTPUT_SEQUENCE };
enum EM_T20_StorageBackend_t { EN_T20_STORAGE_LITTLEFS = 0, EN_T20_STORAGE_SDMMC };
