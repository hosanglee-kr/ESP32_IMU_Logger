...
#include "T20_Mfcc_Inter_205.h"


/* ============================================================================
[컴파일 오류 재발 방지 호환 레이어 - v205]
반복 오류 패턴:
...
static inline uint8_t& T20_ref_bmi270_spi_begin_runtime_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_board_runtime_state; }
static inline uint8_t& T20_ref_bmi270_register_read_runtime_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_read_state; }
static inline uint8_t& T20_ref_bmi270_spi_attach_prep_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_isr_attach_state; }
static inline uint8_t& T20_ref_bmi270_burst_read_prep_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_burst_apply_state; }
static inline uint8_t& T20_ref_bmi270_burst_runtime_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_reg_burst_state; }
static inline uint8_t& T20_ref_bmi270_isr_queue_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_isr_request_state; }
static inline uint8_t& T20_ref_bmi270_real_begin_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_board_runtime_state; }
static inline uint8_t& T20_ref_bmi270_real_burst_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_reg_burst_state; }
static inline uint8_t& T20_ref_bmi270_real_isr_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_isr_attach_state; }
static inline uint8_t& T20_ref_bmi270_hw_link_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_hw_exec_state; }
static inline uint8_t& T20_ref_bmi270_frame_build_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_reg_burst_state; }
static inline uint8_t& T20_ref_bmi270_raw_pipe_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_reg_burst_state; }
static inline uint8_t& T20_ref_bmi270_dsp_ingress_state(CL_T20_Mfcc::ST_Impl* p) { return p->bmi270_read_state; }

static inline uint8_t& T20_ref_recorder_file_write_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_finalize_state; }
static inline uint8_t& T20_ref_recorder_bundle_map_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_index_state; }
static inline uint8_t& T20_ref_recorder_store_bundle_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_index_state; }
static inline uint8_t& T20_ref_recorder_store_result(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_commit_result; }
static inline uint8_t& T20_ref_recorder_path_route_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_package_state; }
static inline uint8_t& T20_ref_recorder_write_commit_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_finalize_commit_state; }
static inline uint8_t& T20_ref_recorder_write_finalize_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_finalize_state; }
static inline uint8_t& T20_ref_recorder_commit_route_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_commit_result; }
static inline uint8_t& T20_ref_recorder_finalize_sync_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_finalize_save_state; }
static inline uint8_t& T20_ref_recorder_real_flush_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_manifest_state; }
static inline uint8_t& T20_ref_recorder_real_close_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_recover_state; }
static inline uint8_t& T20_ref_recorder_real_finalize_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_finalize_state; }
static inline uint8_t& T20_ref_recorder_meta_sync_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_meta_state; }
static inline uint8_t& T20_ref_recorder_report_sync_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_export_state; }
static inline uint8_t& T20_ref_recorder_audit_sync_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_audit_state; }
static inline uint8_t& T20_ref_recorder_manifest_sync_state(CL_T20_Mfcc::ST_Impl* p) { return p->recorder_manifest_state; }
...
bool T20_beginLiveSource(CL_T20_Mfcc::ST_Impl* p)
{
    ...
    if (!T20_configBMI270_2050Hz_DRDY(p)) return false;
    return true;
}
...
bool T20_buildLiveSourceJsonText(CL_T20_Mfcc::ST_Impl* p, char* p_out_buf, uint16_t p_len)
{
    ...
    for (uint8_t i = 0; i < G_T20_BMI270_BURST_AXIS_COUNT; ++i) { axis_values.add(p->bmi270_last_axis_values[i]); }
...
bool T20_configBMI270_2050Hz_DRDY(CL_T20_Mfcc::ST_Impl* p)
{
    if (p == nullptr) return false;
...
/* ============================================================================
[다음 단계 조금 더 크게 묶은 실제 연결 Placeholder - v205]
============================================================================ */
