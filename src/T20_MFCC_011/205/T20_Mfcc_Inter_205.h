...
bool T20_buildHwAndFinalizeSyncJsonText(CL_T20_Mfcc::ST_Impl* p, char* p_out_buf, uint16_t p_len);
    ...
    uint8_t               bmi270_dsp_ingress_state;
    uint8_t               bmi270_raw_pipe_state;
    uint8_t               recorder_audit_sync_state;
    uint8_t               recorder_manifest_sync_state;
