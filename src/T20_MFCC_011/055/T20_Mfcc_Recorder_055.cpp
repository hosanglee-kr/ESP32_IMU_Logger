...
===============================================================================
[컴파일 조정 메모]
- 이번 단계에서는 SD_MMC profile / zero-copy stage buffer / viewer 호환 필드를
  헤더와 일치시키는 정리 패치를 함께 반영했다.
- 실제 DMA/cache aligned write 경로는 아직 skeleton 단계이며 TODO로 유지한다.
===============================================================================
*/
...
===============================================================================
[Recorder 구조 정리]
- recorderTask 중복 정의 가능성을 줄이기 위해 단일 task 정의 기준으로 정리했다.
- zero-copy / DMA / cache aligned는 아직 skeleton 단계이며 TODO 유지.
===============================================================================
*/
