...
namespace T20 {
    ...
    namespace C10_Path {
        ...
        inline constexpr char const* FILE_CFG_JSON = "/sys/runtime_cfg_220_001.json"; // v220 경로 업데이트
        ...
        inline constexpr char const* WEB_INDEX     = "index_220_001.html";            // v220 웹 리소스
...
typedef enum {
    EN_T20_ACCEL_2G = 0, EN_T20_ACCEL_4G, EN_T20_ACCEL_8G, EN_T20_ACCEL_16G
} EM_T20_AccelRange_t;

typedef enum {
    EN_T20_GYRO_125 = 0, EN_T20_GYRO_250, EN_T20_GYRO_500, EN_T20_GYRO_1000, EN_T20_GYRO_2000
} EM_T20_GyroRange_t;

typedef enum {
    EN_T20_FFT_256  = 256, EN_T20_FFT_512  = 512, EN_T20_FFT_1024 = 1024,
    EN_T20_FFT_2048 = 2048, EN_T20_FFT_4096 = 4096
} EM_T20_FftSize_t;

typedef enum {
    EN_T20_AXIS_SINGLE = 1, EN_T20_AXIS_TRIPLE = 3
} EM_T20_AxisCount_t;

// --- [2.2] Preprocess & DSP Enums ---
typedef enum {
    EN_T20_FILTER_OFF = 0, EN_T20_FILTER_LPF, EN_T20_FILTER_HPF
} EM_T20_FilterType_t;

typedef enum {
    EN_T20_NOISE_OFF = 0, EN_T20_NOISE_FIXED, EN_T20_NOISE_ADAPTIVE
} EM_T20_NoiseMode_t;

typedef enum {
    EN_T20_WIFI_STA_ONLY = 0, EN_T20_WIFI_AP_ONLY, EN_T20_WIFI_AP_STA, EN_T20_WIFI_AUTO_FALLBACK
} EM_T20_WiFiMode_t;

typedef enum {
    EN_T20_STORAGE_LITTLEFS = 0, EN_T20_STORAGE_SDMMC
...
typedef struct {
    ...
    ST_T20_TriggerBand_t bands[T20_MAX_TRIGGER_BANDS]; // 다중 주파수 밴드 감시
...
typedef struct {
    ...
    float    band_energy[T20_MAX_TRIGGER_BANDS]; // 감시 중인 밴드들의 최신 에너지
