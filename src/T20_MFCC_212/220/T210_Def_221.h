...
namespace T20 {
    ...
    namespace C10_Path {
        ...
        inline constexpr char const* FILE_CFG_JSON    = "/sys/runtime_cfg_220_001.json"; // 런타임 환경 설정 파일 저장 경로
        ...
        inline constexpr char const* WEB_INDEX        = "index_220_001.html";            // 웹서버 기본 접속 화면 파일명
