...
/* ============================================================================
 * File: T219_Config_Json_220.h
 * Summary: System Configuration JSON Serialization
 * * [AI 메모: 제공 기능 요약]
 * 1. T210_Def_221.h에 정의된 ST_T20_Config_t 마스터 구조체와 JSON 간 양방향 변환.
 ...
 * 3. 새로운 설정 항목이 T210_Def_221.h에 추가되면 이 클래스의 parseFromJson과 
 * buildJson 양쪽 모두에 반드시 업데이트를 누락 없이 반영해야 합니다.
 * ========================================================================== */
#pragma once
