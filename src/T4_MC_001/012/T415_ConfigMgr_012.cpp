 ...
 * 3. [v012 Phase 4 적용]: updateFromJson 호출 시 save() 직결을 끊고,
 * checkLazyWrite()를 통한 3초 디바운스 Lazy Write 메커니즘을 주입하여
 * 플래시 메모리 마모(Wear-out) 및 LittleFS GC 블로킹 완벽 차단.
 * ========================================================================== */
...
// [v012 업그레이드] Lazy Write (지연 쓰기) 적용
...
// [v012 추가] 메인 루프에서 호출되는 Lazy Write 커미터
