 ...
 * ============================================================================
 * File: T450_FsmMgr_005.cpp
 * Summary: FSM Orchestrator & Multi-task Implementation
 * ========================================================================== */

#include "T450_FsmMgr_005.hpp"
#include "esp_log.h"
#include <cstring>
...
void T450_FsmManager::_captureTask(void* p_param) {
    ...
    while(1) {
        ...
        const uint32_t v_hopSamples = (uint32_t)(SmeaConfig::System::SAMPLING_RATE_CONST * (v_cfg.dsp.hop_ms / 1000.0f)); 
