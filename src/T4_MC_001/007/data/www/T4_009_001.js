...
const i18n = {
    en: {
        ...
        title_wifi: "Wi-Fi Connection Mode", lbl_op_mode: "Operation Mode", sub_softap: "Soft-AP Settings", sub_multi_ap: "Target APs (Multi-AP)",
    ...
    ko: {
        ...
        title_wifi: "Wi-Fi 접속 모드", lbl_op_mode: "동작 모드", sub_softap: "독립 AP", sub_multi_ap: "접속 공유기 목록 (순회 접속)",
        title_mqtt_admin: "MQTT 및 기기 관리", sub_dev_mgmt: "기기 관리", btn_backup: "설정 백업", btn_restore: "설정 복원", btn_factory: "공장 초기화", btn_reboot: "기기 재부팅",
        title_ota: "무선 펌웨어(OTA) 업데이트", btn_upload_flash: "펌웨어 업로드/적용", btn_save_sys: "시스템 및 통신 설정 저장"
    }
};
