...
#include "T410_Def_009.hpp"     // 동적/정적 설정 상수
#include "T420_Types_010.hpp"      // 통신 패킷 및 데이터 슬롯 규격
#include "T415_ConfigMgr_009.hpp"  // 런타임 JSON 설정 매니저
