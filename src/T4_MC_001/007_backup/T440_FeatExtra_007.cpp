 ...
 * 5. [매직 넘버 철폐 완료] 하드코딩되었던 상수들(Cepstrum Target, IPD 대역폭 등)을
 * 동적 설정 및 _CONST 상수로 전면 치환.
 * ========================================================================== */
...
void T440_FeatureExtractor::_computeCepstrum(SmeaType::FeatureSlot& p_slot) {
    ...
    // [메모리 최적화] 스택 오버플로우(8KB) 방지를 위해 스크래치용으로 재사용
