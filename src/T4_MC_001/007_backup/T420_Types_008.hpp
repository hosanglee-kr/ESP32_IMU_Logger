 ...
 * * [마이그레이션 적용 사항]
 * - Cepstrum 타겟 수(4) 및 Top Peak 수(5) 배열 크기 매직넘버 철폐 완료.
 * ========================================================================== */
#pragma once
...
namespace SmeaType {
    ...
    struct alignas(16) FeatureSlot {
        ...
        // [Cepstrum 타겟 특징] 정적 상수로 매직넘버 철폐
        float             cpsr_max[SmeaConfig::FeatureLimit::CEPS_TARGET_COUNT_CONST];          // N1 ~ N_MAX
        float             cpsr_mxrms[SmeaConfig::FeatureLimit::CEPS_TARGET_COUNT_CONST];        // N1 ~ N_MAX
