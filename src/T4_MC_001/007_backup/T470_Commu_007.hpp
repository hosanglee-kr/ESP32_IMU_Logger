 ...
 * * [매직 넘버 철폐]: 지연 시간, 배열 크기 등 통신 제어 상수 전면 _CONST 승격.
 * ========================================================================== */
#pragma once
...
private:
    ...
    // MQTT 연결 정보 캐싱 (JSON 구조체를 매번 복사해오지 않기 위함)
...
public:
    ...
    /**
     * @brief WiFi, NTP, WebServer, MQTT 초기화 및 다중 AP 라우팅 설정
     */
    ...
    /**
     * @brief 바이너리 데이터를 WebSocket으로 브로드캐스트 (방어 1 적용)
     */
