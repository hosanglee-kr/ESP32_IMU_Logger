...
class CL_T20_Mfcc_004
{
public:
    CL_T20_Mfcc_004();

    bool begin(const T20_Config_004_t* p_cfg = nullptr);
    bool start(void);
    void stop(void);

    bool setConfig(const T20_Config_004_t* p_cfg);
    void getConfig(T20_Config_004_t* p_cfg_out) const;

    bool getLatestFeatureVector(T20_FeatureVector_004_t* p_out) const;
...
private:
    CL_T20_Mfcc_004(const CL_T20_Mfcc_004&) = delete;
    CL_T20_Mfcc_004& operator=(const CL_T20_Mfcc_004&) = delete;
