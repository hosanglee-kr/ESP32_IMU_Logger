...
#define G_T20_VERSION_STR                   "T20_Mfcc_054"
...
static inline ST_T20_Config_t T20_makeDefaultConfig(void)
{
    ...
    cfg.preprocess.noise.noise_learn_frames = 8;
...
/*
 * SD_MMC 보드 프로파일 골격
 * - 보드별 pin/mode/profile 실제 적용은 향후 단계 TODO
 */
typedef struct
{
 ...
 * ============================================================================
 */
#ifndef T20_COMPAT_TYPES_054_DEFINED
#define T20_COMPAT_TYPES_054_DEFINED
...
typedef ST_T20_RotateItem_t ST_T20_RecorderIndexItem_t;
