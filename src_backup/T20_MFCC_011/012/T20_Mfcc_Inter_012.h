...
#include "T20_Mfcc_012.h"

/*
===============================================================================
소스명: T20_Mfcc_Inter_012.h
버전: v012
...
[향후 단계 TODO]
- SD_MMC recorder runtime
- AsyncWeb route/runtime state
...
struct CL_T20_Mfcc::ST_Impl
{
    ...
    // Legacy raw frame buffers kept for future DMA / writer extension
    ...
    // Config-time filter cache (legacy / status visibility)
    float biquad_coeffs[5];
    float biquad_state[2];
