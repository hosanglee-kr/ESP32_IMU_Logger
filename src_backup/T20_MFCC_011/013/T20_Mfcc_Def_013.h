...
/* ============================================================================
 * File: T20_Mfcc_Def_013.h
 * Summary:
 *   T20 MFCC / vibration feature module의 공개 정의 헤더
 *
 * [이번 단계 반영]
 * 1) 012 구조 기준 실컴파일 대응 보완용 상수/타입 정리
 * 2) SD_MMC recorder 대묶음 C용 공개 설정 구조 추가
 * 3) raw / config / metadata / event 저장 포맷 설정 추가
 *
 * [향후 단계 TODO]
 * - recorder 실제 쓰기 task 분리
 * - AsyncWeb 설정 변경 / 측정 시작·종료 / 데이터 시각화
 * - live waveform / live feature API
 * - snapshot별 FFT / mel bank cache 분리
...
#define G_T20_VERSION_STR                   "T20_Mfcc_013"
